...
namespace Airfare.Data.Repository.Admin
{
    public class OperatorRepository : IDisposable, IOperatorRepository
    {
        ...
        public void UpdateOperator(FlightOperator flightOperatorFromRepo)
        {
            ...
            //var flightToUpdate = _context.FlightOperator.Where(_ => _.OperatorId == flightOperatorDataModel.OperatorId).FirstOrDefault();

            //flightToUpdate.CompanyName = flightOperatorDataModel.CompanyName;
            //flightToUpdate.BaseFare = flightOperatorDataModel.BaseFare;
            //flightToUpdate.Tax = flightOperatorDataModel.Tax;
            //flightToUpdate.Convience = flightOperatorDataModel.Convience;
