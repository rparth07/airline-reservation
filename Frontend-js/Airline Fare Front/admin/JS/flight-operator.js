...
function filterData(event, paginateOperator) {
...
function bindOpratorSuggestionEvent(paginateOperator) {
    ...
    $("input").on("click", function () {
        ...
        $(searchInput).on("keyup", function () {
            ...
            renderOpratorChoice(searchInput, suggestionListElement, suggestionString, paginateOperator);
        });
    });
}
function renderOpratorChoice(searchInput, suggestionListElement, suggestionString, paginateOperator) {
...
function bindPageChangeEvent(paginateOperator) {
    $(".pageChange").on("click", function () {
        changePageAndPrintData(paginateOperator, parseInt(this.getAttribute("data-page-number"), 10));
    });
}
function changePageAndPrintData(paginateOperator, currentPage) {
    paginateOperator.pageChange(currentPage, "#operatorData");
    printOperatorData(paginateOperator.getCurrentPageData(), currentPage, paginateOperator.getPageSize());
}
